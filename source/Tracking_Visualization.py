...
def plot_sliding_window(match_object,
    ...
    if pass_graph:
        ...
        pass_network_home_renderer = plot.segment(x0="Start X mean", y0="Start Y mean", x1="End X mean",
                                                  y1="End Y mean", color=match_object.home_color, line_width="Freq",
        ...
        pass_network_away_renderer = plot.segment(x0="Start X mean", y0="Start Y mean", x1="End X mean",
                                                  y1="End Y mean", color=match_object.away_color, line_width="Freq",
        ...
        if pass_graph:
            if pass_network_home_renderer.visible:
                ...
                passes_home = home_events_df[
                    (home_events_df['Type'] == 'PASS') & (home_events_df["From"].str.split("_").str[0] == "Home")].groupby(['From',
                                                                                                               'To',
                                                                                                               'Start Time [s]',
                                                                                                               'End Time [s]',
                                                                                                               'Start X',
        ...
        if pass_graph:
            if pass_network_away_renderer.visible:
                ...
                passes_away = away_events_df[
                    (away_events_df['Type'] == 'PASS') & (away_events_df["From"].str.split("_").str[0] == "Away")].groupby(
                    ['From',
                     'To',
                     'Start Time [s]',
                     'End Time [s]',
