...
def read_match_data(DATADIR,gameid):
    ...
    goalkeeper_home = find_goalkeeper(tracking_home)
    goalkeeper_away = find_goalkeeper(tracking_away)

    tracking_home = tracking_home.rename(columns={'Home_'+goalkeeper_home+'_x': 'Home_11_x',
                                                'Home_11_x': 'Home_'+goalkeeper_home+'_x',
                                                'Home_'+goalkeeper_home+'_y': 'Home_11_y',
                                                'Home_11_y': 'Home_'+goalkeeper_home+'_y'
                                                })

    tracking_away = tracking_away.rename(columns={'Away_'+goalkeeper_away+'_x': 'Away_22_x',
                                                'Away_22_x': 'Away_'+goalkeeper_away+'_x',
                                                'Away_'+goalkeeper_away+'_y': 'Away_22_y',
                                                'Away_22_y': 'Away_'+goalkeeper_away+'_y'
                                                })
